...
public class LunarUtil {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        today.setTime(chineseDateFormat.parse("2018-06-03"));
        LunarUtil lunar = new LunarUtil(today);
        System.out.println(lunar);
    }
    public static String getDayStr() throws ParseException {
        Date date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String d = dateFormat.format(date);
        Calendar today = Calendar.getInstance();
        ...
        d=d.substring(5);
        String[] ds=d.split("-");
        ds[0]=ds[0].replaceFirst("^0","");
        ds[1]=ds[1].replaceFirst("^0","");
        return ds[0]+"-"+ds[1]+"@"+lunar.toString();
    }
}