...
public class MD5Utils {
    ...
    public static void main(String args[]) throws ParseException {
        //MD5 md5= new MD5();
//	String source  ="admin";
//	String s=toMD5(source);
//	System.out.println("s:"+s);//21232F297A57A5A743894A0E4A801FC3
//	
//	String source2  ="123";
//	String s2=toMD5(source2);
//	System.out.println("123 s2:"+s2);//202CB962AC59075B964B07152D234B70
        String a = "2b94567df072eff40ae6ea1160b40b1e" + "_" + "下半场" + "_" + "255";
        String b = "2b94567df072eff40ae6ea1160b40b1e" + "_" + "下半年" + "_" + "255";
        String c = MD5(a);
        String d = MD5(b);
